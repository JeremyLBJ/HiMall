...
public class ClassificationofGoodsItem {
	...
	//第一个价格
		...
		private List<CartsTable> tables ;
    ...
    public List<CartsTable> getTables() {
		return tables;
	}

	public void setTables(List<CartsTable> tables) {
		this.tables = tables;
	}
	...
	public String toString() {
		return "ClassificationofGoodsItem [priceOne=" + priceOne + ", priceTow=" + priceTow + ", totalNum=" + totalNum
				+ ", totalPages=" + totalPages + ", brandName=" + brandName + ", imginfos=" + imginfos + ", tables="
				+ tables + ", id=" + id + ", cid=" + cid + ", cname=" + cname + ", inventory=" + inventory + ", images="
				+ images + ", price=" + price + ", orderno=" + orderno + ", brand=" + brand + ", createtime="
				+ createtime + ", detail=" + detail + ", showstatus=" + showstatus + "]";
	}
